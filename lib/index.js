...
function createScrollingComponent(WrappedComponent) {
  var ScrollingComponent = function (_Component) {
    ...
    function ScrollingComponent(props, ctx) {
      ...
      _this.updateScrolling = (0, _lodash2.default)(function (evt) {
        ...
        var box = _this.props.scrollingElement ? {
          x: 0,
          y: 0,
          w: _this.viewportWidth(),
          h: _this.viewportHeight()
        } : { x: x, y: y, w: w, h: h };
    ...
    _createClass(ScrollingComponent, [{
      ...
      value: function componentDidMount() {
        ...
        this.container = this.props.scrollingElement ? document.scrollingElement : (0, _reactDom.findDOMNode)(this.wrappedInstance);
      ...
      value: function startScrolling() {
        ...
        var tick = function tick() {
          ...
          if (i++ % 2) {
            ...
            if (_this3.props.scrollingElement) {
              clientHeight = _this3.viewportHeight();
              clientWidth = _this3.viewportWidth();
            }
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            scrollingElement = _props2.scrollingElement,
            props = _objectWithoutProperties(_props2, ['strengthMultiplier', 'verticalStrength', 'horizontalStrength', 'onScrollChange', 'scrollingElement']);
  ...
  ScrollingComponent.propTypes = {
    ...
    scrollingElement: _propTypes2.default.bool
  };
